...
CREATE TABLE `venue` (
  ...
  KEY `aid` (`aid`),
  CONSTRAINT `venue_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `admin` (`aid`) ON DELETE SET NULL
...
INSERT INTO `venue` VALUES (1,'CSE','SJCIT,BB road, Chickballapur-562101','2019-12-25',1);
